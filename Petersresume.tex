...
\resheading{Summary}
  ...
  Pursuing a career which leverages these skills to develop
...
\resheading{Skills}
\begin{itemize}
	\resitem{\textbf{Software:} GNU Octave, Linux, \LaTeX, Mathematica, git, BASH}
	\resitem{\textbf{Programming Languages:} \textsc{matlab}, C, Java, Python}
\end{itemize}
%----------END SKILLS-----------%
