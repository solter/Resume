...
\resheading{Summary}
  ...
  Experience developing software and algorithms to model space weather
  and its affects on terrestrial communication. Searching for a position
  which leverages my mathematical and scientific background to develop
  cutting-edge scientific software.
...
\begin{itemize}
\item%ARL work    
  \ressubheading{Software Engineer/Mathematician}{\href{https://www.northropgrumman.com}{Northrop Grumman}}{\href{http://www.northropgrumman.com/Capabilities/SpaceWeatherAnalysis/Pages/default.aspx}{SWAFS}}{Feb. 2017 -- present}
  {\footnotesize
  \begin{itemize}  
    \resitem{Primary Responsibilities: modernize software infrastructure, improve software practices, space weather algorithm analysis}
  \end{itemize}
  }
\item%ARL work    
...
\begin{itemize}
  \resitem{\textbf{Software Practices:} (automated) unit testing, cross-language development}
  \resitem{\textbf{Software Tools:} git, mercurial, Linux, Maven, JIRA, vim, \LaTeX, Mathematica, \textsc{matlab}}
  \resitem{\textbf{Programming Languages:} Python, Java, Fortran (Modern and 77), BASH, C, C++, SQL}
\end{itemize}
%----------END SKILLS-----------%
