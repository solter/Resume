...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
  \textbf{\LARGE Peter Solfest} & \email \\
    \address & \phone  \\
  & Clearance Level: Secret (Interim TS)
\end{tabular*}
\\
\vspace{0.1in}}
...
\resheading{Summary}
  ...
  I am a software engineer with system modeling experience and interest/education in numerical methods, mathematicsm, and physics.
...
\begin{itemize}
\item%NG GBSD
  \ressubheading{Software Engineer}{\href{https://www.northropgrumman.com}{Northrop Grumman}}{
      GBSD}{Mar 2021 -- present}
  {\footnotesize
  \begin{itemize}  
    ...
    \resitem{Roles: LETS Team Scrum Master, Jira Administrator, Software Developer}
  \end{itemize}
  }
\item%NGSWAFS
  \ressubheading{Mathematician}{\href{https://www.northropgrumman.com}{Northrop Grumman}}{
      \href{http://www.northropgrumman.com/Capabilities/SpaceWeatherAnalysis/Pages/default.aspx}{SWAFS},
        Weather and Space Impacts Research and Development Center}{Feb 2017 -- Mar 2021}
  {\footnotesize
  \begin{itemize}  
    %\resitem{Primary Responsibilities: modernize software infrastructure, develop/improve software
      %    processes, develop innovative  new applications to demonstrate space weather impacts,
...
\begin{itemize}
  ...
  \resitem{\textbf{Tools:} Fortify, GitHub, git, Jenkins, JIRA,  \LaTeX, Linux, Make, \textsc{matlab}, Maven, mercurial, Neo4j, React.js, SharePoint, SonarQube}
